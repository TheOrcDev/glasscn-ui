  ...
  return (
    <div className="flex flex-col gap-10 max-w-[1400px] mx-auto px-4 py-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <CodeSnippet>{`pnpm dlx shadcn@canary add ${process.env.NEXT_PUBLIC_BASE_URL}/r/glass-button.json`}</CodeSnippet>
        <p>
          The command above will add the Button component to your project. You
          can then import it like this:
        </p>
        <CodeSnippet>{`import { Button } from "@/components/ui/glass/button"
